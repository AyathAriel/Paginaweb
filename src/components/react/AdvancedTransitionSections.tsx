...
interface Section {
  ...
  transitionType: "cube" | "flip" | "carousel" | "perspective" | "fold"
}

export default function AdvancedTransitionSections() {
  ...
  // Get 3D transition variants based on transition type and direction
  const get3DTransitionVariants = (type: Section["transitionType"], direction: "up" | "down") => {
    const duration = 0.8
  ...
  const navigateToSection = (index: number) => {
    ...
    // After transition is complete, reset transitioning state
    setTimeout(() => {
      ...
      <div className="preserve-3d">
        <AnimatePresence mode="wait">
          <motion.div
            ...
            {...get3DTransitionVariants(sections[activeSection].transitionType, transitionDirection)}
